...
export const UpdateLaporanPKS = () => {
  ...
  useEffect(()=> {
    const getLaporanPksById = async () => {
      try {
        const response = await axios.get(`http://localhost:5006/laporanpks/${id}`)
  ...
  const updateLaporanPks = async (e) => {
    e.preventDefault();
    try {
      await axios.patch(`http://localhost:5006/laporanpks/${id}`,{
        no_mou: no_mou,
        no_pks: no_pks,
        tentang: tentang,
        pic: pic,
    ...
    style={{ marginLeft: "200px", padding: "70px" }}>
      <div className="card is-shadowless">
          <div className="card-content">
            ...
            <form onSubmit={updateLaporanPks} style={{marginLeft:"-100px"}}>
...
export default UpdateLaporanPKS;